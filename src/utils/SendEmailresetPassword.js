...
const SendEmailresetPassword=(email,firstName,frontBaseUrl,code)=>{
    sendEmail({
        ...
        <p style="font-size: 18px; line-height: 1.6; margin-bottom: 25px; text-align: center;">Para actualizar su contraseña por favor, haga clic en el siguiente enlace:</p>
